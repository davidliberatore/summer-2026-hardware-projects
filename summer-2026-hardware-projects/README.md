...
| 2 | [Audio Amplifier](./project-2-audio-amplifier) | ✅ Complete | TL072 op-amp pre-amp + 2N3904/2N3906 BJT push-pull output stage, 8Ω speaker |
| 3 | [Custom PCB Environmental Sensor Node](./project-3-env-sensor-node) | ✅ Complete | ATmega328P + DHT22 + SSD1306 OLED, custom fabricated PCB |
